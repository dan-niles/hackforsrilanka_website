...
<head>
  ...
  <title>Hack For Sri Lanka | Home</title>
  ...
  <main class="flex-shrink-0">
        ...
        <div class="row gx-5 align-items-center justify-content-center">
          <div class="col-lg-8 col-xl-7 col-xxl-6">
            <div class="my-5 text-center text-xl-start">
              <h1 class="display-5 fw-bolder text-white mb-2">Find when the power goes out in your area!
              </h1>
              ...
              <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                <a class="btn btn-warning btn-lg px-4" href="#features">Get Started</a>
          ...
          <div class="col-lg-8">
            <div class="row gx-5 row-cols-1 row-cols-md-2">
              <div class="col mb-5 h-100">
                <div class="feature bg-warning text-dark bg-gradient rounded-3 mb-3"><i class="bi bi-collection"></i></div>
                <h2 class="h5">Featured title</h2>
                <p class="mb-0">Paragraph of text beneath the heading to explain the heading. Here is
                  just a bit more text.</p>
              </div>
              <div class="col mb-5 h-100">
                <div class="feature bg-warning text-dark bg-gradient rounded-3 mb-3"><i class="bi bi-building"></i></div>
                <h2 class="h5">Featured title</h2>
                <p class="mb-0">Paragraph of text beneath the heading to explain the heading. Here is
                  just a bit more text.</p>
              </div>
              <div class="col mb-5 mb-md-0 h-100">
                <div class="feature bg-warning text-dark bg-gradient rounded-3 mb-3"><i class="bi bi-toggles2"></i></div>
                <h2 class="h5">Featured title</h2>
                <p class="mb-0">Paragraph of text beneath the heading to explain the heading. Here is
                  just a bit more text.</p>
              </div>
    ...
    <section class="py-5">
      <div class="container px-5 my-5">
        ...
        <div class="row gx-5">
          <div class="col-lg-4 mb-5">
            <div class="card h-100 shadow border-0">
              ...
              <div class="card-body p-4">
                <div class="badge bg-warning text-dark bg-gradient rounded-pill mb-2">News</div>
                <a class="text-decoration-none link-light stretched-link" href="#!">
          ...
          <div class="col-lg-4 mb-5">
            <div class="card h-100 shadow border-0">
              ...
              <div class="card-body p-4">
                <div class="badge bg-warning text-dark bg-gradient rounded-pill mb-2">Media</div>
                <a class="text-decoration-none link-light stretched-link" href="#!">
        ...
        <!-- Call to action-->
        <aside class="bg-warning text-dark bg-gradient rounded-3 p-4 p-sm-5 mt-5">
