            ...
            <div class="col-12">
              <div class="card widget-card">
                <div class="card-header">
                  <div class="row">
                    <div class="col-5">
                      ...
                      <h3 style="display:inline"> Order Form</h3>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <form method="post" name="rd_form" id="rd_form" action="<?php echo base_url(); ?>gen_admin/gen_admin_controller/order_form" OnSubmit="return confirmation();">
                    <div id='data-table-div' style="display:none" class="px-4">
                      <table id="customerTable" class="table table-bordered px-4" width="100%">
                        <tbody>
                          <tr>
                            <td class="font-weight-bolder text-md my-auto" colspan="6" align="center"><img class="mr-2 mb-1" style="width: 60px" src="<?php echo base_url() ?>assets/img/astron-logo.png" alt=""> ORDER FORM</td>
                          </tr>
                          <tr>
                            <td colspan="2">
                              ...
                              <div class="container mt-3">
                                <div class="row ml-3">
                                  <div class="col-12 my-2 d-flex">
                                    ...
                                    <input type="hidden" name="OFHID" id="OFHID" value="0">
                                    <input class="form-control form-control-sm" style="width: 250px" type="text" value="Invoice No : " readonly>
                                    <input class="form-control form-control-sm font-weight-bold" type="text" name="InvoiceNo" id="InvoiceNo" value="EXP/MKNZ/USA/2021/2" readonly>
                                  </div>
                                  <div class="col-12 my-2 d-flex">
                          ...
                          <tr>
                            <td rowspan="2"></td>
                            <td rowspan="2"></td>
                            <td colspan="3">Total Invoice Value (USD) :</td>
                            <td colspan="1"><input type="text" class="form-control item-total" readonly></td>
                          </tr>
                          <tr>
                            <td colspan="3">Total Weight (Kg) :</td>
                            <td colspan="1"><input type="text" class="form-control" name="TotalWeight" id="TotalWeight"></td>
                          </tr>
                        </tbody>
                      </table>
                      <div class="row">
  ...
  <script type="text/javascript">
    ...
    $(document).on('click', '#loadBtn', function() {
      ...
      if (InquiryID != "" && InquiryID != 0 && InquiryID != null) {
        $.ajax({
          type: "POST",
          url: "<?php echo base_url() ?>gen_admin/gen_admin_controller/get_shipment_inq_details_for_of",
          data: {
            InquiryID: InquiryID
          },
          dataType: "json",
          ...
          success: function(data) {
            ...
            if (data.response == true) {
              ...
              data.detail.forEach(function(e) {
                ...
                toAppend += '<td>'
                toAppend += '<input type="hidden" name="OFDID[]" value="' + e.OFDID + '">'
              ...
              setTotal()
              if (data.header.OFHID != 0) {
                $('.printBtn').data('ID', data.header.OFHID)
                $('.printBtn').show();
              } else {
                $('.printBtn').data('ID', data.header.OFHID)
                $('.printBtn').hide();
    ...
    $(document).on('click', '.printBtn', function(e) {
      var ID = $(this).data('ID')
      $(this).prop('href', '<?php echo base_url() ?>gen_admin/gen_admin_controller/print_order_form/' + ID)
    })
    ...
    $(document).on('click', '#add-item-rows', function(e) {
      ...
      if (ProductName != "" && Qty != "" && Price != "") {
        ...
        toAppend += '<td>'
        toAppend += '<input type="hidden" name="OFDID[]" value="0">'
