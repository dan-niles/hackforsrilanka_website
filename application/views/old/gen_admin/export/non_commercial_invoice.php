...
<body class="hold-transition sidebar-mini text-sm">
                ...
                <div class="card-header">
                  <div class="row">
                    <div class="col-5">
                      ...
                      <h3 style="display:inline"> Non Commercial Invoice</h3>
                    </div>
                      ...
                      <table id="customerTable" class="table table-bordered px-4" width="100%">
                        <tbody>
                              ...
                              <div class="container mt-3">
                                <div class="row ml-3">
                                  <div class="col-12 my-2 d-flex">
                                    ...
                                    <input class="form-control form-control-sm font-weight-bold" type="text" name="OFNo" id="OFNo" value="EXP/MKNZ/USA/2021/2" readonly>
                                  </div>
                                  <div class="col-12 my-2 d-flex">
                          ...
                          <tr>
                            ...
                            <td colspan="1"><input type="text" class="form-control" name="TotalWeight" id="TotalWeight" readonly></td>
                          </tr>
                        </tbody>
                      </table>
                      <div class="row">
  ...
  <script type="text/javascript">
    ...
    $(document).on('change', '#drp_customer', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url() ?>gen_admin/gen_admin_controller/fetch_of_inv_no",
        data: {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data.response == true) {
              ...
              $('#OFNo').val(data.header.InvoiceNo)
