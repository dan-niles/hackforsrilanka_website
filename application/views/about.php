    ...
    <main class="flex-shrink-0">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xxl-6">
                        <div class="text-center my-5">
                            ...
                            <p class="lead fw-normal text-white-50 mb-4">We are a team of data scientists and computer programmers with a vision to democratize data. We have a deep passion for harnessing technology and data to help people.</p>
        ...
        <section class="py-5 bg-light" id="scroll-target">
            <div class="container px-5 my-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6"><img class="img-fluid rounded-3 my-5" src="<?php echo base_url() ?>assets/img/protest.jpeg" alt="..." /></div>
                    <div class="col-lg-6">
                        <h2 class="fw-bolder text-white">What's happening in Sri Lanka?</h2>
                        <p class="lead fw-normal text-white-50 mb-0">Sri Lanka is facing its worst economic crisis in more than 100 years.
                            Soaring inflation and a rapidly-depreciating local currency mean that the country can no
                            longer afford basic goods. A lack of foreign money has led to power cuts that last 10 or more hours every day.
                            Food shortages are causing hours-long lines at grocery stores as political unrest is mounting.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="py-5">
            <div class="container px-5 my-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <h2 class="fw-bolder text-white ">Our Goal</h2>
                        <p class="lead fw-normal text-white-50 mb-0">Sri Lankan citizens need access to important data that impacts their lives.
                            Many of these data are publicly available but difficult to access. We want to ensure that those living in Sri Lanka have access to accurate and essential data, starting with real time power outage upates.
                        </p>
                    </div>
                    <div class="col-lg-6"><img class="img-fluid rounded-3 my-5" src="<?php echo base_url() ?>assets/img/home.jpeg" alt="..." /></div>
                </div>
            </div>
        </section>
